...
FOLDER = r'G:\Meu Drive\Viagens\2017-12 Jo' + chr(227) + 'o Pessoa'
XLSX   = FOLDER + r'\Viagem Jo' + chr(227) + 'o Pessoa.xlsx'
PFX    = 'joaopessoa-2017'

wb      = openpyxl.load_workbook(XLSX)
wb_data = openpyxl.load_workbook(XLSX, data_only=True)

# Col A(0)=date, Col C(2)=summary, activities D-J (0-idx 3-9), hosp_col=J(9), skip K(10)=maré
...
trip = build_trip(PFX, "2017-12 Jo" + chr(227) + "o Pessoa",
