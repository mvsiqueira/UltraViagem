...
FOLDER = r'G:\Meu Drive\Viagens\2015-12 Teres' + chr(243) + 'polis'
XLS    = FOLDER + r'\Viagem Teres' + chr(243) + 'polis.xls'
PFX    = 'tere-2015-dez'
...
trip = build_trip(PFX, "2015-12 Teres" + chr(243) + "polis",
    "2015-12-31", "2016-01-03", 4, maps_url, itinerary, expenses, links, attachments)
