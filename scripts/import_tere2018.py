...
FOLDER = r'G:\Meu Drive\Viagens\2018-03 Teres' + chr(243) + 'polis'
XLSX   = FOLDER + r'\Viagem Teres' + chr(243) + 'polis.xlsx'
PFX    = 'tere-2018'
...
DATES    = ["2018-04-20","2018-04-21","2018-04-22"]
SUMMARIES = ["Ida","Parnaso","Ter" + chr(234) + "-Fri"]

DAYS_DEF = [
    (3, 0, [(9,'a01','Transporte'),(11,'a02','Passeio'),(12,'a03','Hospedagem')]),
    (4, 1, [(5,'a04','Passeio'),(8,'a05','Refeicao'),(9,'a06','Passeio')]),
    (5, 2, [(5,'a07','Passeio'),(6,'a08','Passeio'),(7,'a09','Passeio'),(8,'a10','Refeicao'),
            (9,'a11','Passeio'),(10,'a12','Passeio'),(11,'a13','Passeio'),(12,'a14','Transporte')]),
]
...
def parse_gastos_brl(ws_g, ws_g_data, pfx, pi, ti, ppli, qi, pagi):
    ...
    for rr, rd in zip(ws_g.iter_rows(min_row=2), ws_g_data.iter_rows(min_row=2)):
        ...
        if not etype:
            ...
            elif any(w in tl for w in ['ingresso','passeio','trilha','parque']): etype='Passeios'
...
trip = {
    "schemaVersion":1,"id":PFX,"title":"2018-04 Teres" + chr(243) + "polis",
    "startDate":"2018-04-20","endDate":"2018-04-22",
