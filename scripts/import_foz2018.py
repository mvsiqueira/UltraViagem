...
FOLDER = r'G:\Meu Drive\Viagens\2018-02 Foz do Igua' + chr(231) + 'u'
XLSX   = FOLDER + r'\Viagem Foz do Igua' + chr(231) + 'u.xlsx'
PFX    = 'foz-2018'
...
DATES     = ["2018-02-08","2018-02-09","2018-02-10","2018-02-11","2018-02-12"]
SUMMARIES = ["Ida","Cataratas","Templo Budista","Puerto Igua" + chr(122) + chr(250),"Duty Free"]

DAYS_DEF = [
    (3, 0, [(9,'a01','Transporte')]),
    (4, 1, [(4,'a02','Passeio'),(6,'a03','Passeio'),(8,'a04','Passeio'),(9,'a05','Passeio')]),
    (5, 2, [(4,'a06','Passeio'),(7,'a07','Passeio'),(8,'a08','Passeio')]),
    (6, 3, [(4,'a09','Transporte'),(6,'a10','Passeio'),(9,'a11','Passeio')]),
    (7, 4, [(4,'a12','Transporte'),(6,'a13','Passeio'),(8,'a14','Passeio'),(9,'a15','Transporte')]),
]
...
def parse_gastos_brl(ws_g, ws_g_data, pfx, pi, ti, ppli, qi, pagi):
    ...
    for rr, rd in zip(ws_g.iter_rows(min_row=2), ws_g_data.iter_rows(min_row=2)):
        ...
        if not etype:
            ...
            elif any(w in tl for w in ['safari','ingresso','passeio','parque']): etype='Passeios'
...
trip = {
    "schemaVersion":1,"id":PFX,"title":"2018-02 Foz do Igua" + chr(231) + "u",
    "startDate":"2018-02-08","endDate":"2018-02-12",
    "baseCurrency":"BRL","people":6,"rateDecimalDigits":2,"myMapsUrl":maps_url,
