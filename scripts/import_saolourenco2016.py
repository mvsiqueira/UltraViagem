...
FOLDER = r'G:\Meu Drive\Viagens\2016-03 S' + chr(227) + 'o Louren' + chr(231) + 'o'
XLS    = FOLDER + r'\Viagem S' + chr(227) + 'o Louren' + chr(231) + 'o.xls'
PFX    = 'saolourenco-2016'
...
trip = build_trip(PFX, "2016-03 S" + chr(227) + "o Louren" + chr(231) + "o",
    "2016-03-24", "2016-03-27", 5, maps_url, itinerary, expenses, links, attachments)
