...
FOLDER = r'G:\Meu Drive\Viagens\2015-12 Punta Cana'
XLS    = FOLDER + r'\Viagem Punta Cana.xls'
PFX    = 'puntacana-2015'
...
itinerary = parse_xls_roteiro(wb, wb.sheet_by_name('Roteiro'),
    date_col=1, sum_col=3, act_cols=range(4, 12), first_col=4, data_start=3, pfx=PFX)

links, maps_url = parse_dicas_xls(wb.sheet_by_name('Dicas'), PFX, title_col=1, url_col=2)
expenses = []
...
trip = build_trip(PFX, "2015-12 Punta Cana",
