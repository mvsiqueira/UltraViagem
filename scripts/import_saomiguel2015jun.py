...
FOLDER = r'G:\Meu Drive\Viagens\2015-06 S' + chr(227) + 'o Miguel dos Milagres'
XLS    = FOLDER + r'\Viagem S' + chr(227) + 'o Miguel dos Milagres.xls'
PFX    = 'saomiguel-2015-jun'
...
trip = build_trip(PFX, "2015-06 S" + chr(227) + "o Miguel dos Milagres",
